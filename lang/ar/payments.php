...
return [
    ...
    'follow_ups' => [
        'title' => 'سجل المتابعة',
        'description' => 'تابع التذكيرات اليدوية وردود المستأجر ووعود السداد لهذه الدفعة.',
        'empty' => 'لا توجد متابعات مسجلة لهذه الدفعة بعد.',
        'type' => 'نوع المتابعة',
        'note' => 'ملاحظة المتابعة',
        'promised_date' => 'تاريخ السداد الموعود',
        'promised_amount' => 'المبلغ الموعود',
        'created_by' => 'أضيفت بواسطة',
        'save' => 'حفظ المتابعة',
        'saved' => 'تم حفظ المتابعة.',
        'log_reminder' => 'تسجيل التذكير',
        'promise_indicator' => 'وعد بالسداد',
        'types' => [
            'note' => 'ملاحظة',
            'reminder_logged' => 'تم تسجيل تذكير',
