...
<div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    ...
    <div data-building-actions class="grid gap-2 sm:flex sm:flex-wrap">
        <a class="tap-target inline-flex min-h-11 items-center justify-center rounded bg-slate-900 px-4 text-center text-sm font-medium text-white" href="{{ route('buildings.units.bulk.create', $building) }}">{{ __('units.bulk.add_multiple') }}</a>
