...
<form method="post" action="{{ $building->exists ? route('buildings.update', $building) : route('buildings.store') }}" class="max-w-xl space-y-4 rounded border bg-brand-surface p-4 shadow-sm">
